        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              BreakTime: <span style="color:red;"><?php
               ...
               <script>
                function myFunction() {
                var prtCon tent = document.getElementById("print1");
              ...
              <table id="recipes" class="table table-striped table-advance table-hover" >
                <tbody>
                  <tr>
                    ...
                    <th style="text-align: center;"><i class=""></i>User</th>
...
$servername = "localhost";
	...
	$sql_select = "SELECT * from break_time JOIN users ON break_time.user_id=users.id ORDER by break_time.id DESC";
	...
	while($row = $result1->fetch_assoc())
                        ...
                        $id=$row['id'];			
                        $user_id=$row['user_id'];
                        $clock_in1=$row['clock_in1'];
                        $clock_out1=$row['clock_out1'];
                        $name=$row['name'];
